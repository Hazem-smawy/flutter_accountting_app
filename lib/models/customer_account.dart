...
class CustomerAccount {
  ...
  factory CustomerAccount.fromJson(String source) => CustomerAccount.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'CustomerAccount(id: $id, customerId: $customerId, curencyId: $curencyId, accgroupId: $accgroupId, totalCredit: $totalCredit, totalDebit: $totalDebit, createdAt: $createdAt)';
  }
